...
if(empty($_SESSION['nik'])){ ?>
    ...
    alert('Login Diperlukan Untuk Mengakses Halaman Ini');
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-4 text-gray-800">
                        ...
                        if(!empty(@$_GET['url'])){
                            ...
                            echo"Selamat Datang Di Aplikasi Peduli Diri, Dimana Aplikasi Ini Digunakan Untuk Mencatat Riwayat Perjalanan Anda Selama bepergian Keluar Rumah.";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Peduli Diri Zidan Zamorano 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
